      ...
      <div className="w-full max-w-xl rounded-2xl border border-slate-200 bg-white shadow-sm p-8">
        <div className="flex items-start gap-4">
          <div className={`h-11 w-11 rounded-xl flex items-center justify-center ${
            showInDevelopment ? "bg-amber-50 border border-amber-200 text-amber-600" : "bg-slate-50 border border-slate-200 text-slate-600"
          }`}>
          ...
          <div className="flex-1">
            ...
            <p className="mt-2 text-sm text-slate-600 leading-relaxed">
              {showInDevelopment ? (
                ...
                <>Trenutno nemate dodijeljene permisije za modul <span className="font-bold text-slate-800">{moduleName}</span>.
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Link href="/profile" className="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-black uppercase tracking-widest text-slate-700 hover:bg-slate-50">
                Moj profil
              </Link>
            </div>
          </div>
