                ...
                <div className="space-y-4 max-w-2xl mx-auto">
                    {scale.map((s, i) => (
                        <div key={i} className="flex items-center gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                            ...
                            <div><label className="text-[10px] font-bold text-slate-400 uppercase">Farbe</label><input type="color" value={s.colorHex} onChange={(e) => {const n=[...scale]; n[i].colorHex=e.target.value; setScale(n)}} className="h-8 w-8 cursor-pointer border-0 rounded"/></div>
