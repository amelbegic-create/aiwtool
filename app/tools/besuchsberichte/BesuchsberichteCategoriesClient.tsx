      ...
      <div className="min-h-screen bg-background font-sans text-foreground pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 sm:py-6 md:py-8">
          ...
          <div className="mt-8 rounded-2xl border border-[#1a3826]/10 dark:border-[#FFC72C]/20 bg-gradient-to-br from-emerald-50/40 via-card to-[#1a3826]/5 dark:from-[#1a3826]/10 dark:via-card dark:to-[#1a3826]/5 shadow-lg p-10 md:p-16 text-center">
            ...
            <h2 className="text-xl font-bold text-foreground">Kein Standort gewählt</h2>
            <p className="text-sm text-muted-foreground mt-2 max-w-sm mx-auto">
              Bitte wählen Sie oben einen Standort, um Besuchsberichte anzuzeigen.
            </p>
          </div>
        </div>
      </div>
              ...
              >
                {filtered.map((cat, index) => {
                  ...
                  return (
                    ...
                    >
                      <Link
                        href={`/tools/besuchsberichte/${cat.id}`}
